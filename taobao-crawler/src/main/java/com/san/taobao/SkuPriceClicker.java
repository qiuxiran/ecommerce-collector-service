...
public final class SkuPriceClicker {
    ...
    private SkuPriceClicker() {
    }

    public static boolean enabled() {
        return !"false".equalsIgnoreCase(System.getProperty("taobao.sku-click", "true"));
    }

    private static int maxSkus() {
        try {
            return Integer.parseInt(System.getProperty("taobao.sku-click-max", "200"));
     ...
     */
    public static int fillMissingPrices(ChromeDriver driver, MtopSniffer sniffer, ItemDetail detail) {
        if (!enabled() || detail == null || detail.skuList.isEmpty()) {
            return 0;
        }
