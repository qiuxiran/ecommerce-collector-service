 ...
 * <p>
 * 运行：{@code mvn -q compile exec:java -Dmain.class=com.san.taobao.ParserSelfCheck}
 */
public final class ParserSelfCheck {
    ...
    public static void main(String[] args) {
        ...
        // item.images(2) ∪ headImageVO.images(2，其中 1 张重复) = 3 张
        ...
        // 价格：price 取到手价（低），cost_price 取原价（高）
        ...
        // 属性：SKU 维度在前，BASE_PROPS 在后，噪声被排除
    ...
    /**
     * 一部分商品（{@code skuItem.hideOtherPrice=true}）页面只下发库存不下发 SKU 价，
     * 这时应退化到整品级 priceVO，而不是留一片 null。这里把基准 fixture 的 SKU 价剥掉来复现。
     */
